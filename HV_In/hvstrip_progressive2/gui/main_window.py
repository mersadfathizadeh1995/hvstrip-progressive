...
from .pages.parallel_batch_page import ParallelBatchPage
...
class MainWindow(MSFluentWindow):
    ...
    def __init__(self):
        ...
        self.researchPage = ResearchPage(self)
        self.parallelBatchPage = ParallelBatchPage(self)
    ...
    def initNavigation(self):
        ...
        # Add parallel batch page
        self.addSubInterface(
            self.parallelBatchPage,
            FIF.SPEED_HIGH,
            'Parallel Batch (5000)',
            FIF.SPEED_HIGH
        )
