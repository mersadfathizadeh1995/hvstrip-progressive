...
def process(hv_csv_path: str, model_txt_path: str, output_dir: str, 
    ...
    # Get amplitude ON THE CURVE (from smoothed data) for marker placement
    a0_on_curve = amps_plot[idx]
    
    # Create outputs dict (store original peak amplitude for analysis)
    ...
    ax.scatter(f0, a0_on_curve, s=100, color='#E63946', zorder=5, 
    ...
    ax.annotate(f'f₀ = {f0:.2f} Hz\nA = {a0_on_curve:.1f}',
                xy=(f0, a0_on_curve), xytext=(x_text, y_text),
